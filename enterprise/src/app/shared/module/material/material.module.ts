...
import { MatCommonModule, MatLineModule, MatNativeDateModule,
  MatOptionModule, MatPseudoCheckboxModule, MatRippleModule
...
@NgModule({
  ...
  imports: [
    CommonModule,
    MatAutocompleteModule, MatCommonModule, MatFormFieldModule,
    MatLineModule, MatNativeDateModule, MatOptionModule,
    ...
    MatSlideToggleModule, MatSliderModule, MatSnackBarModule,
  ...
  exports: [
    MatAutocompleteModule, MatCommonModule,
    MatLineModule, MatNativeDateModule, MatOptionModule,
    MatPseudoCheckboxModule, MatRippleModule,
